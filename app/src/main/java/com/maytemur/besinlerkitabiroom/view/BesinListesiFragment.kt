...
import com.maytemur.besinlerkitabiroom.adapter.BesinRecyclerAdapter
import com.maytemur.besinlerkitabiroom.viewmodel.BesinListesiViewModel
...
class BesinListesiFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        swipeRefreshLayout.setOnRefreshListener {
            ...
            viewModel.refreshfromInternet() //viewModel.refreshData() yerine internetten alıyoruz artık
